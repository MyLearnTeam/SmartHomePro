...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/plugins/gritter/jquery.gritter.css" rel="stylesheet">

</head>

<body class="gray-bg animated fadeInRight" style="color: #676a6c">
	...
	<script src="${pageContext.request.contextPath}/resources/plugins/flot/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath}/resources/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/plugins/flot/jquery.flot.spline.js"></script>
    <%-- <script src="${pageContext.request.contextPath}/resources/plugins/flot/jquery.flot.resize.js"></script> --%>
    <script src="${pageContext.request.contextPath}/resources/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${pageContext.request.contextPath}/resources/plugins/flot/jquery.flot.symbol.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/resources/plugins/easypiechart/jquery.easypiechart.js"></script>
