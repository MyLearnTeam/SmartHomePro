$(function () {
    ...
    function openPage() {
        ...
        if (k) {
            var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o + '">' + l + ' <b class="fa fa-refresh"></b>   <i class="fa fa-times-circle"></i></a>';
    ...
    $(".J_menuTabs").on("click", ".J_menuTab b", refresh_tab);
    $("#refresh_tab").on("click", refresh_tab);
...
function redirects(el) {
    var o = $(el).attr("hrefs"), m = $(el).data("index"), l = $.trim($(el).text()), k = true;
    if (o == undefined || $.trim(o).length == 0) {
        return false
    }
    $(".J_menuTab").each(function () {
        if ($(el).data("id") == o) {
            if (!$(el).hasClass("active")) {
                $(el).addClass("active").siblings(".J_menuTab").removeClass("active");
                g(el);
                $(".J_mainContent .J_iframe").each(function () {
                    if ($(el).data("id") == o) {
                        $(el).show().siblings(".J_iframe").hide();
                        return false
                    }
                })
            }
