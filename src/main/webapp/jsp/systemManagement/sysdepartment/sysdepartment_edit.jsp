...
<body style="overflow: auto; height: 100%; padding: 0px">
	<div class="wrapper wrapper-content animated fadeIn">
		<form id="inputForm" name="inputForm" action="updateSysDepartment">
			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
				<tr height=25>
					...
					<td><input type="text" name="parentname" id="parentname" value="${parentname}" readonly="readonly" style="width:300px"><input type="hidden" name="parent_id" id="parent_id"
						value="${sysdepartment.parent_id}"> [<a href="javascript:SearchBack()">选择</a>]</td>
				</tr>
				<tr height=25>
					<td align="right" width="30%"><label ID="lbl_depart_code" style="color: #0066FF">部门编号</label></Td>
					<td><input type="text" id="depart_code" name="depart_code" maxlength=20 class="form-control" value="${sysdepartment.depart_code}"></td>
				</tr>
				<tr height=25>
					<td align="right" width="30%"><label ID="lbl_depart_name" style="color: #0066FF">部门名称</label><font color=red>*</font></Td>
					<td><input type="text" id="depart_name" name="depart_name" maxlength=50 class="form-control" required="required" value="${sysdepartment.depart_name}"></td>
				</tr>
				<tr height=25>
					<td align="right" width="30%"><label ID="lbl_remark" style="color: #0066FF">说明</label></Td>
					<td><textarea id="remark" name="remark" rows="5" class="form-control">${sysdepartment.remark}</textarea></td>
				</tr>
			</table>
