...
<body style="overflow: auto; height: 100%; padding: 0px">
	<div class="wrapper wrapper-content animated fadeIn">
		<form id="inputForm" name="inputForm" action="saveSysRole">
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
				<tr height=25>
					<td align="right" width="30%"><label ID="lbl_role_name" style="color: #0066FF">角色名称</label><font color=red>*</font></Td>
					<td><input type="text" id="role_name" name="role_name" maxlength=50 class="form-control" required="required"></td>
				</Tr>
				<tr height=25>
					<td align="right" width="30%"><label ID="lbl_role_code" style="color: #0066FF">角色编码</label></Td>
					<td><input type="text" id="role_code" name="role_code" maxlength=30 class="form-control"></td>
				</Tr>
				<tr height=25>
					<td align="right" width="30%" style="vertical-align: top;"><label ID="lbl_remark" style="color: #0066FF">备注</label></Td>
