...
<title>数据词典 new</title>
<%@ include file="../../base/baseCss.jsp"%>
</head>
<body style="overflow: auto; height: 100%; padding: 0px">
   <div class="wrapper wrapper-content animated fadeIn">
       <form id="inputForm" name="inputForm" action="saveSysBasedata" onsubmit="return false">
           <table class="parent-table">
             ...
             <tr  >
               ...
               <td><input type="text" id="param_token" name="param_token" maxlength=30  class="form-control"></td>
             </tr>
             <tr  >
               <td align="right"  width="30%" ><label   ID="lbl_pvalue">数据值</label></td>
               <td><input type="text" id="pvalue" name="pvalue"     class="form-control"  required="required" number="true"></td>
             </tr>
             <tr  >
               <td align="right"  width="30%" ><label   ID="lbl_ptext">数据中文</label></td>
               <td><input type="text" id="ptext" name="ptext" maxlength=150 required="required" class="form-control"></td>
             </tr>
             <tr  >
               <td align="right"  width="30%" ><label   ID="lbl_remark">说明</label></td>
               <td><input type="text" id="remark" name="remark" maxlength=200  class="form-control"></td>
             </tr>
         </table>
